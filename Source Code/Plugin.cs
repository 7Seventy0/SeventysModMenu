...
namespace SeventysModMenu
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        IEnumerator SeventysStart()
        {
            ...
            assetLoadRequest = myLoadedAssetBundle.LoadAssetAsync<GameObject>("GorillaRocket");
            yield return assetLoadRequest;
            GameObject rocket = assetLoadRequest.asset as GameObject;

            assetLoadRequest = myLoadedAssetBundle.LoadAssetAsync<GameObject>("SilentShot");
            yield return assetLoadRequest;
            GameObject silentshot = assetLoadRequest.asset as GameObject;

            assetLoadRequest = myLoadedAssetBundle.LoadAssetAsync<GameObject>("water");
            yield return assetLoadRequest;
            GameObject water = assetLoadRequest.asset as GameObject;
